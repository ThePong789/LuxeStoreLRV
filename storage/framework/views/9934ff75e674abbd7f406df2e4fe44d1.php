...
<div class="page-hero">
    <h1>My Orders</h1>
    <div class="breadcrumb"><a href="<?php echo e(route('home')); ?>">Home</a> <span>/</span> <span>Orders</span></div>
</div>
<div class="container">
    <div class="orders-wrap">
        <?php if($orders->isEmpty()): ?>
            <div style="text-align:center;padding:5rem 2rem;">
                ...
                <a href="<?php echo e(route('shop')); ?>" class="btn btn-primary" style="padding:.9rem 2.5rem;">Shop Now</a>
            </div>
        <?php else: ?>
            ...
            <div class="order-card">
                <div class="order-card-header">
                    <div>
                        <div style="font-weight:700;font-size:.9rem;">Order No.<?php echo e($order->order_id); ?></div>
                        <div style="font-size:.75rem;color:var(--gray);margin-top:2px;"><?php echo e($order->created_at->format('F d, Y')); ?></div>
                    </div>
                    <div style="display:flex;align-items:center;gap:1rem;">
                        <span class="badge badge-<?php echo e($colors[$order->status] ?? 'secondary'); ?>" style="font-size:.8rem;padding:.35rem .85rem;"><?php echo e(ucfirst($order->status)); ?></span>
                        <a href="<?php echo e(route('orders.show', $order->order_id)); ?>" class="btn btn-outline btn-sm">View Details</a>
                    </div>
                </div>
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;">
                        <div class="order-items-preview">
                            ...
                            <?php if($order->items->count() > 4): ?>
                                <div class="order-thumb" style="background:var(--black);color:#fff;font-weight:600;">+<?php echo e($order->items->count() - 4); ?></div>
                            <?php endif; ?>
                        </div>
                        <div style="text-align:right;">
                            <div style="font-size:.8rem;color:var(--gray);"><?php echo e($order->items->sum('qty')); ?> item(s)</div>
                            <div style="font-weight:700;font-size:1.05rem;">$<?php echo e(number_format($order->total_price, 2)); ?></div>
                            <?php if($order->payment): ?><div style="font-size:.75rem;color:var(--gray);">via <?php echo e(ucfirst(str_replace('_',' ',$order->payment->payment_method))); ?></div><?php endif; ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\vesot\Downloads\Telegram Desktop\ecommerce-laravel-v6-fixed (2)\ecommerce-laravel-v6-fixed\ecommerce-laravel-fixed\resources\views/orders/index.blade.php ENDPATH**/ ?>