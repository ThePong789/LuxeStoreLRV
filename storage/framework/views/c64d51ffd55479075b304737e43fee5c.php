...
<div class="page-hero">
    ...
    <div class="breadcrumb"><a href="<?php echo e(route('home')); ?>">Home</a> <span>/</span> <span>Contact</span></div>
</div>
            ...
            <div class="contact-form-card">
                ...
                <form action="<?php echo e(route('contact.send')); ?>" method="POST">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:.75rem;">
                        <div class="form-g"><label>First Name *</label><input type="text" name="first_name" placeholder="John" value="<?php echo e(old('first_name')); ?>" required></div>
                        <div class="form-g"><label>Last Name *</label><input type="text" name="last_name" placeholder="Doe" value="<?php echo e(old('last_name')); ?>" required></div>
                    </div>
                    <div class="form-g"><label>Email *</label><input type="email" name="email" placeholder="you@example.com" value="<?php echo e(old('email')); ?>" required></div>
                    <div class="form-g"><label>Subject</label>
                        <select name="subject">
                            <option value="">Select a subject</option>
                            <option <?php echo e(old('subject') == 'Order Inquiry' ? 'selected' : ''); ?>>Order Inquiry</option>
                            <option <?php echo e(old('subject') == 'Product Question' ? 'selected' : ''); ?>>Product Question</option>
                            <option <?php echo e(old('subject') == 'Returns & Refunds' ? 'selected' : ''); ?>>Returns & Refunds</option>
                            <option <?php echo e(old('subject') == 'General Feedback' ? 'selected' : ''); ?>>General Feedback</option>
                            <option <?php echo e(old('subject') == 'Other' ? 'selected' : ''); ?>>Other</option>
                        </select>
                    </div>
                    <div class="form-g"><label>Message *</label><textarea name="message" placeholder="How can we help you?" required><?php echo e(old('message')); ?></textarea></div>
                    <?php if($errors->any()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lucksing\Downloads\ecommerce-laravel-v6-fixed (2)\ecommerce-laravel-v6-fixed\ecommerce-laravel-fixed\resources\views/home/contact.blade.php ENDPATH**/ ?>