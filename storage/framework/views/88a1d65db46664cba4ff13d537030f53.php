...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> | LuxeStore Admin</title>
...
<aside class="sidebar">
    ...
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('admin.products.index')); ?>" class="<?php echo e(request()->routeIs('admin.products*') ? 'active' : ''); ?>"><i class="fas fa-box"></i> Products</a></li>
        <li><a href="<?php echo e(route('admin.categories.index')); ?>" class="<?php echo e(request()->routeIs('admin.categories*') ? 'active' : ''); ?>"><i class="fas fa-tags"></i> Categories</a></li>
    </ul>
    <span class="sidebar-label">Commerce</span>
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('admin.orders.index')); ?>" class="<?php echo e(request()->routeIs('admin.orders*') ? 'active' : ''); ?>"><i class="fas fa-shopping-cart"></i> Orders</a></li>
        <li><a href="<?php echo e(route('admin.reviews.index')); ?>" class="<?php echo e(request()->routeIs('admin.reviews*') ? 'active' : ''); ?>"><i class="fas fa-star"></i> Reviews</a></li>
    </ul>
    <span class="sidebar-label">Content</span>
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('admin.blog.index')); ?>" class="<?php echo e(request()->routeIs('admin.blog*') ? 'active' : ''); ?>"><i class="fas fa-newspaper"></i> Blog</a></li>
    </ul>
    <span class="sidebar-label">Users</span>
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e(request()->routeIs('admin.users*') ? 'active' : ''); ?>"><i class="fas fa-users"></i> Users</a></li>
    </ul>
    <?php else: ?>
    <span class="sidebar-label">Main</span>
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('staff.dashboard')); ?>" class="<?php echo e(request()->routeIs('staff.dashboard') ? 'active' : ''); ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
    </ul>
    <span class="sidebar-label">Catalog</span>
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('staff.products.index')); ?>" class="<?php echo e(request()->routeIs('staff.products*') ? 'active' : ''); ?>"><i class="fas fa-box"></i> Products</a></li>
        <li><a href="<?php echo e(route('staff.categories.index')); ?>" class="<?php echo e(request()->routeIs('staff.categories*') ? 'active' : ''); ?>"><i class="fas fa-tags"></i> Categories</a></li>
    </ul>
    <span class="sidebar-label">Commerce</span>
    <ul class="sidebar-nav">
        <li><a href="<?php echo e(route('staff.orders.index')); ?>" class="<?php echo e(request()->routeIs('staff.orders*') ? 'active' : ''); ?>"><i class="fas fa-shopping-cart"></i> Orders</a></li>
        <li><a href="<?php echo e(route('staff.reviews.index')); ?>" class="<?php echo e(request()->routeIs('staff.reviews*') ? 'active' : ''); ?>"><i class="fas fa-star"></i> Reviews</a></li>
    </ul>
    <?php endif; ?>

    <ul class="sidebar-nav" style="margin-top:auto;">
        <li><a href="<?php echo e(route('home')); ?>"><i class="fas fa-globe"></i> View Store</a></li>
    </ul>

    <div class="sidebar-footer">
        <div class="user-info">
            <div class="avatar"><?php echo e(strtoupper(substr(auth()->user()->username, 0, 1))); ?></div>
            <div>
                <div style="color:#fff;font-weight:500;font-size:.8rem;"><?php echo e(auth()->user()->username); ?></div>
                <div><?php echo e(auth()->user()->role->role_name ?? ''); ?></div>
            </div>
        </div>
        <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin-top:.75rem;">
            <?php echo csrf_field(); ?>
...
<div class="main-wrap">
    <header class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb"><?php echo $__env->yieldContent('breadcrumb', 'Home'); ?></div>
        </div>
        <div class="topbar-actions">
            <a href="<?php echo e(route('home')); ?>"><i class="fas fa-globe"></i> Storefront</a>
        </div>
    </header>
...
<?php /**PATH C:\Users\vesot\Downloads\Telegram Desktop\ecommerce-laravel-v6-fixed (2)\ecommerce-laravel-v6-fixed\ecommerce-laravel-fixed\resources\views/layouts/admin.blade.php ENDPATH**/ ?>