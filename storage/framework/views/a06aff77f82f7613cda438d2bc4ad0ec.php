        ...
        <div class="card-body">
            <form action="<?php echo e(route($routePrefix.'.categories.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="category_name" class="form-control" value="<?php echo e(old('category_name')); ?>" required>
                </div>
                <div class="form-group">
                    ...
                    <tr>
                            ...
                            <div style="display:flex;align-items:center;gap:.75rem;">
                                <div style="width:40px;height:40px;background:var(--bg);border-radius:8px;overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;color:var(--text-muted);">
                                    <?php if($cat->category_image): ?>
                                        <img src="<?php echo e(asset('storage/'.$cat->category_image)); ?>" style="width:100%;height:100%;object-fit:cover;">
                                    <?php else: ?> <i class="fas fa-tag"></i> <?php endif; ?>
                                </div>
                                <div>
                                    <div style="font-weight:500;font-size:.875rem;"><?php echo e($cat->category_name); ?></div>
                                    <div style="font-size:.75rem;color:var(--text-muted);"><?php echo e(Str::limit($cat->description, 40)); ?></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div style="display:flex;gap:.4rem;">
                                <button class="btn btn-outline btn-xs" onclick="editCat(<?php echo e($cat->category_id); ?>, '<?php echo e(addslashes($cat->category_name)); ?>', '<?php echo e(addslashes($cat->description ?? '')); ?>', '<?php echo e($cat->category_image ? asset('storage/'.$cat->category_image) : ''); ?>')">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <form action="<?php echo e(route($routePrefix.'.categories.destroy', $cat->category_id)); ?>" method="POST" onsubmit="return confirm('Delete category?')">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lucksing\Downloads\ecommerce-laravel-v6-fixed (2)\ecommerce-laravel-v6-fixed\ecommerce-laravel-fixed\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>