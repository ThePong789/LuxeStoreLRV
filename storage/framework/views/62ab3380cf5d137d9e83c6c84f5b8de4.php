...
<div class="auth-form-wrap">
    <div class="auth-form">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="row-2">
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" class="form-control" value="<?php echo e(old('first_name')); ?>" placeholder="John">
                </div>
                <div class="form-group">
                    <label class="form-label">Last Name</label>
                    <input type="text" name="last_name" class="form-control" value="<?php echo e(old('last_name')); ?>" placeholder="Doe">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" name="username" class="form-control" value="<?php echo e(old('username')); ?>" placeholder="johndoe" required>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="auth-link" style="margin-top:.75rem;"><a href="<?php echo e(route('home')); ?>"><i class="fas fa-arrow-left"></i> Back to store</a></div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\Lucksing\Downloads\ecommerce-laravel-v6-fixed (2)\ecommerce-laravel-v6-fixed\ecommerce-laravel-fixed\resources\views/auth/register.blade.php ENDPATH**/ ?>