                ...
                <div class="cart-cards">
                    ...
                    <div class="cart-card">
                        ...
                        <div class="cart-card-body">
                            <div class="cart-card-name"><?php echo e($item->product->product_name ?? 'Product'); ?></div>
                            <div class="cart-card-size">Size: <?php echo e($item->size->size_name ?? 'N/A'); ?></div>
                            <div class="cart-card-footer">
                                ...
                                <div class="cart-card-price">$<?php echo e(number_format($item->price * $item->qty, 2)); ?></div>
                                <form action="<?php echo e(route('cart.remove', $item->cart_item_id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lucksing\Downloads\ecommerce-laravel-v6-fixed (2)\ecommerce-laravel-v6-fixed\ecommerce-laravel-fixed\resources\views/cart/index.blade.php ENDPATH**/ ?>