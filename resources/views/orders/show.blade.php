...
<div class="container">
    <div class="order-detail-wrap">
        ...
        <div class="detail-card">
            <div class="order-status-track">
                ...
                <div class="status-step">
                    ...
                    <div class="status-label {{ $currentIdx !== false && $i <= $currentIdx ? ($currentIdx === $i ? 'active' : 'done') : '' }}">
                        {{ ucfirst($step) }}
                    </div>
                </div>
                @endforeach
            ...
            <div class="detail-card-body" style="padding:0;">
                ...
                <div style="display:flex;align-items:center;gap:1rem;padding:1.1rem 1.5rem;border-bottom:1px solid #f5f5f5;">
                    ...
                    <div style="flex:1;">
                        ...
                        <div style="font-size:.8rem;color:var(--gray);">
                            Size: {{ $item->size->size_name ?? 'N/A' }} · Qty: {{ $item->qty }}
                        </div>
                    </div>
                ...
                <div style="padding:1.1rem 1.5rem;display:flex;justify-content:flex-end;">
                    <div style="text-align:right;">
                        ...
                        <div style="font-size:1.5rem;font-family:var(--font-display);font-weight:700;">
        ...
        <!-- SHIPPING + PAYMENT -->
        <div class="ship-pay-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">

            @if($order->shipping)
            <div class="detail-card">
                <div class="detail-card-header">
                    <h3><i class="fas fa-map-marker-alt" style="color:var(--gold);margin-right:.4rem;"></i> Shipping Address</h3>
                </div>
            ...
            <div class="detail-card">
                <div class="detail-card-header">
                    <h3><i class="fas fa-credit-card" style="color:var(--gold);margin-right:.4rem;"></i> Payment</h3>
                </div>
                <div class="detail-card-body" style="font-size:.875rem;">
                    ...
                    <div style="display:flex;justify-content:space-between;">
                        <span>Status</span>
                        <span class="badge {{ $order->payment->status === 'paid' ? 'badge-success' : 'badge-warning' }}">
